...
public class OOPBasic {
	...
	public static void main(String[] args) {		//String형 타입의 1개, void : 반환타입

		/*
		1. OOP : Object Oriented Programming -> 객체지향 프로그래밍
		  - 기존의 프로그래밍 언어에 몇가지 규칙을 추가한 것보다 발전된 언어이다.
		...
		6. 선언 위치에 따른 변수의 종류
		  - 지역변수
		    : 메서드 내에 선언된다.
		    : 언제 메모리에서 사라질까? => 메서드가 종료시 같이 소멸된다.
		...
		13. 메서드의 종류
		  - 클래스메서드
		    ...
		    : 클래스메서드 내에서는 인트턴스 멤버는 사용할 수 없다.
		    : 클래스메서드 내에서 인스턴스멤버를 사용하지 않고 있다면 클래스메서드로 만드는 것을 고려해야 한다.
		  - 인터턴스메서드
